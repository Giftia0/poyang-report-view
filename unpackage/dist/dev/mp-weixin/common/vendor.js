    ...
    function r2(a2) {
      return new Promise(function(h2, c2) {
        if (g2.Loca === b2.failed)
          ...
          var f2 = d2.Loca.version, e2 = d2.AMap.version.startsWith("2"), l2 = f2.startsWith("2");
          if (e2 && !l2 || !e2 && l2)
            ...
            k.type = "text/javascript";
            k.src = "https://webapi.amap.com/loca?v=" + f2 + "&key=" + e2;
            k.onerror = function(a3) {
              g2.Loca = b2.failed;
              c2("请求 AMapUI 失败");
            };
    ...
    return { load: function(a2) {
      return new Promise(function(h2, c2) {
        if (g2.AMap == b2.failed)
          ...
          var f2 = a2.key, e2 = a2.version, l2 = a2.plugins;
          f2 ? (window.AMap && "lbs.amap.com" !== location.host && c2("禁止多种API加载方式混用"), d2.key = f2, d2.AMap.version = e2 || d2.AMap.version, d2.AMap.plugins = l2 || d2.AMap.plugins, g2.AMap = b2.loading, e2 = document.body || document.head, window.___onAPILoaded = function(d3) {
          ...
          if (a2.key && a2.key !== d2.key)
            ...
            f2 = [];
            if (a2.plugins)
              for (e2 = 0; e2 < a2.plugins.length; e2 += 1)
                -1 == d2.AMap.plugins.indexOf(a2.plugins[e2]) && f2.push(a2.plugins[e2]);
            if (f2.length)
          ...
          if (a2.plugins)
            for (e2 = 0; e2 < a2.plugins.length; e2 += 1)
              -1 == d2.AMap.plugins.indexOf(a2.plugins[e2]) && k.push(a2.plugins[e2]);
          t2(function() {
            if (k.length)
...
const AMapLoader = distExports;
const pages = [
  {
    path: "pages/index/index",
    style: {
      navigationBarTitleText: "举报线索"
    }
  },
  {
  ...
  {
    path: "pages/PickPoint/PickPoint",
    style: {
  ...
  {
    path: "pages/SubmitClue/SubmitClue",
    style: {
      navigationBarTitleText: "咨询反馈",
      enablePullDownRefresh: false
    }
  },
  {
...
const tabBar = {
  ...
  list: [
    ...
    {
      text: "举报",
      pagePath: "pages/SubmitClue/SubmitClue",
      iconPath: "static/icon/tabbar/user/user.png",
      selectedIconPath: "static/icon/tabbar/user/user-selected.png"
    },
    {
      text: "我的",
...
const globalStyle = {
  ...
  navigationBarBackgroundColor: "#047ff2"
};
const uniIdRouter = {};
const e = {
  pages,
...
class st extends Xe {
  async signIn(e2, t2) {
    ...
    const { refreshTokenKey: n2 } = this._cache.keys, s2 = await this._request.send("auth.signIn", { loginType: "EMAIL", email: e2, password: <REDACTED_PASSWORD> refresh_token: this._cache.getStore(n2) || "" }), { refresh_token: r2, access_token: i2, access_token_expire: o2 } = s2;
    if (r2)
...
class rt extends Xe {
  async signIn(e2, t2) {
    ...
    const { refreshTokenKey: n2 } = this._cache.keys, s2 = await this._request.send("auth.signIn", { loginType: We.USERNAME, username: e2, password: <REDACTED_PASSWORD> refresh_token: this._cache.getStore(n2) || "" }), { refresh_token: r2, access_token_expire: i2, access_token: o2 } = s2;
    if (r2)
...
class it {
  ...
  async signUpWithEmailAndPassword(e2, t2) {
    return this._request.send("auth.signUpWithEmailAndPassword", { email: e2, password: <REDACTED_PASSWORD> });
  }
